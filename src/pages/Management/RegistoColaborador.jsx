...
export const RegistoColaborador = () => {
  ...
  useEffect(() => {
    getAllRoles()
      ...
      .catch((error) => {
        // handle any error state, rejected promises, etc..
        NotificationManager.error(
          "Houve erro ao carregar os Roles",
          "Erro!",
          5000
        );
      });
  ...
  useEffect(() => {
    getAllColaboradores()
      ...
      .catch((error) => {
        // handle any error state, rejected promises, etc..
        NotificationManager.error(
          "Houve erro ao carregar os Colaboradores",
          "Erro!",
          5000
        );
      });
  ...
  const handleSalvarColaborador = async () => {
    ...
    if (role_name === "") {
      NotificationManager.error(
        "Selecione o Papel do Utilizador",
        "Erro!",
        5000
      );
      return;
      ...
      if (!emailRegex2.test(email)) {
        NotificationManager.error(
          "Email Deve ser do dominio @ccsaude.org.mz ",
          "Erro!",
          5000
        );
        return;
      ...
      const selectedAreas = areasProgramaticas.filter((item) =>
        areaName.includes(item.area)
      );
      ...
      try {
        ...
        try {
          ...
          NotificationManager.error(
            "Houve erro ao carregar os Colaboradores" + error.message,
            "Erro!",
            5000
          );
        ...
        if (error.response.data.message === "colaborador already exists") {
          NotificationManager.error(
            "Usuario : { " + email + " } ja existe!",
            "Duplicado",
            8000
          );
        } else {
          NotificationManager.error(
            "Houve erro ao ao criar o utilizador:" + error.message,
            "Erro: " + error.code,
            8000
          );
        }
      ...
      if (areaName.length === 0) {
        NotificationManager.error(
          "Selecione a Area do Utilizador",
          "Erro!",
          5000
        );
        return;
          ...
          <div className="px-2 mx-auto mainCard">
            <div className="flex justify-center items-center h-screen">
              <span className="us-header">
                <p>Registo de Novo Colaborador: </p>
              </span>
        ...
        <main className="h-full">
          ...
          <div className="px-2 mx-auto mainCard">
            ...
            <div className=" gap-y-4 overflow-hidden overflow-y-auto center wrapper-requisicoes ">
              <ColaboradoresTable
                colunas={columnNamesColaborador}
                  ...
                  >
                    ...
                    /> */}
                      ...
                      <TableRow>
                        ...
                        <TableCell align="left">
                          {/*  <Button variant="contained" onClick={handleSalvarColaborador}  disabled={enableSalvar }>Salvar</Button> */}
                        </TableCell>
                        <TableCell align="left">
                          {/* <Button variant="contained" onClick={handleCancel} disabled = {false} >Cancelar</Button> */}
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
