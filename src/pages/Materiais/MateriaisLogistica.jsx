...
import { getMaterialDisponivel, getMaterialLogistica  } from "../../middleware/MaterialService";
 ...
 useEffect(() => {
  getMaterialLogistica()
    ...
    .catch(error => {
      ...
      NotificationManager.info('Houve um erro da conectar com o servidor.  Contacte o Administrador do Sistema','Erro getList (material and Armazens)', 4000);
      setError(true);
      setHasFinishedLoading(true);
...
if(!islogged){
  ...
  return (
    ...
    NotificationManager.info('Houve umn erro da conectar com o servidor.  Contacte o Administrador do Sistema','Erro getList (material and Armazens)', 4000);
  } else {
            ...
            return (
              ...
              <main className="h-full">
                ...
                <div className="px-2 mx-auto mainCard">
                  ...
                  {/* <div className="flex flex-row gap-x-4 overflow-hidden overflow-y-auto justify-between "> */}
                   <div className=" gap-y-4 overflow-hidden overflow-y-auto center wrapper-requisicoes ">
                   <MaterialLogisticaTable colunas = {columnNames}  dados = {mappedData}  />
                  </div>
