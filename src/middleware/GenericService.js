...
export async function createArea(data) {
  try{
    const response = await api.post('/rpc/sp_insert_area',data, {headers: {'Prefer': 'return=representation'}} );
    return  response.data;
}
catch(error) {
  throw error;
...
export async function createProjecto(data) {
  try{
    const response = await api.post('/rpc/sp_insert_projecto',data, {headers: {'Prefer': 'return=representation'}} );
    return  response.data;
}
catch(error) {
  throw error;
...
export async function createArmazem(data) {
  try{
    const response = await api.post('/rpc/sp_insert_armazem',data, {headers: {'Prefer': 'return=representation'}} );
    return  response.data;
}
catch(error) {
  throw error;
...
export async function createColaborador(data) {
  try{
    const response = await api.post('/rpc/sp_insert_colaborador',data, {headers: {'Prefer': 'return=representation'}} );
    return  response.data;
}
catch(error) {
  throw error;
...
export async function updateUsuarioStatus(user) {
  try{
    const response = await api.post('/rpc/sp_update_usuario_status',user, {headers: {'Prefer': 'return=representation'}} );
    return  response;
}
catch(error) {
  throw error;
...
export async function updateAreaStatus(area) {
  try{
    const response = await api.post('/rpc/sp_update_area_status',area, {headers: {'Prefer': 'return=representation'}} );
    return  response;
}
catch(error) {
  throw error;
...
export async function updateArea(area) {
  try{
    const response = await api.post('/rpc/sp_update_area',area, {headers: {'Prefer': 'return=representation'}} );
    return  response;
}
catch(error) {
  throw error;
...
export async function updateProjectoStatus(project) {
  try{
    const response = await api.post('/rpc/sp_update_projecto_status',project, {headers: {'Prefer': 'return=representation'}} );
    return  response;
}
catch(error) {
  throw error;
...
export async function updateProjecto(project) {
  try{
    const response = await api.post('/rpc/sp_update_projecto',project, {headers: {'Prefer': 'return=representation'}} );
    return  response;
}
catch(error) {
  throw error;
